...
Watcher :: Watcher(const QString& theName, const QSettings& theData)
  : myName(theName), myHandler(-1), myState(false)
{}
...
{
#if MEMNOTIFY_DUMP
  printf ("Watcher %08x: name '%s' hander %d state %d\n",
          (unsigned)this, myName.toAscii().constData(), myHander, myState
    );
